        ...
        <div>
            ...
            <div className="text-center">
                <div className="shadow stats stats-vertical lg:stats-horizontal">
                    <Link to={"/dashboard/admin/products"} className="stat w-52 h-52 hover:bg-gray-400">
                    ...
                    <Link to={"/dashboard/admin/orders"} className="stat w-52 h-52 hover:bg-gray-400">
                    ...
                    <Link to={"/dashboard/admin/payments"} className="stat w-52 h-52 hover:bg-gray-400">
