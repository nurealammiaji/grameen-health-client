...
const ManageProducts = () => {
    return (
        <div>
            ...
            <div>
                <div className="w-10/12 mx-auto divider"><h3 className="text-2xl font-bold text-success">Manage Products</h3></div>
            </div>
            <br />
            <div className="items-center justify-around gap-5 text-center md:flex">
                ...
                <div className="mt-5 md:mt-0">
                    <button disabled className="btn btn-outline btn-error"><RiDeleteBin2Fill className="text-2xl" />Product</button>
                </div>
            </div>
            <br />
            <AddProduct />
