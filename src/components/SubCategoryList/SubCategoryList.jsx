...
const SubCategoryList = ({ subCategory, index, isSelected, onCheckboxChange, onStatusChange }) => {

    const { _id, name, image, description, category, status } = subCategory;
    ...
    return (
        <tr>
            ...
            <td>
                <Link to={`/dashboard/admin/subCategories/${_id}`} className="btn btn-xs btn-info btn-outline">Details</Link>
            </td>
        </tr>
    );
};
