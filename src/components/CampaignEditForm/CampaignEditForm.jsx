            ...
            <form onSubmit={handleSubmit(handleAddCampaign)} className="p-5 mx-auto border rounded-xl bg-base-200">
                <div className="grid gap-5 md:grid-cols-2">
                    <div className="w-full form-control">
                        ...
                        <input {...register("name", { required: true })} type="text" defaultValue={name} placeholder="Type name here" className="w-full input input-bordered" />
                    ...
                    <div className="w-full form-control">
                        ...
                        <select {...register("status", { required: true })} defaultValue={status} className="w-full select select-bordered">
                    ...
                    <div className="w-full form-control">
                        ...
                        <select {...register("campaignType", { required: true })} defaultValue={campaignType}
                    ...
                    <div className="w-full form-control">
                        ...
                        <input {...register("startDate", { required: true })} type="datetime-local" defaultValue={startDate} placeholder="Select Start Date" className="w-full input input-bordered" />
                    ...
                    <div className="w-full form-control">
                        ...
                        <input {...register("endDate", { required: true })} type="datetime-local" defaultValue={endDate} placeholder="Select End Date" className="w-full input input-bordered" />
                        {errors.name?.type === 'required' && <span className="text-error">{t('requiredDate')} !!</span>}
                    </div>
                </div>
                <div className="w-full mt-5 form-control">
                    ...
                    <textarea {...register("description", { required: true })} rows={5} defaultValue={description} className="w-full textarea textarea-bordered" placeholder="Type descriptions here"></textarea>
